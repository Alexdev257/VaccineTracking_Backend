...
public partial class DbSwpVaccineTracking2Context : DbContext
{
    ...
    protected override void OnConfiguring( DbContextOptionsBuilder optionsBuilder )
        => optionsBuilder.UseSqlServer( "data source=TieHung\\SQLEXPRESS;initial catalog=DB_SWP_Vaccine_Tracking2;user id=sa;password=123456;TrustServerCertificate=True" );
